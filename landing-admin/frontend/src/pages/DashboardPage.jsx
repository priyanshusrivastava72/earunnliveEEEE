...
const DashboardPage = () => {
  ...
  const SECTION_KEY_HEADER = "header";
  ...
  const [activeTab, setActiveTab] = useState("header"); // header | hero | session | cta | featured | transform | learn | featurecards | powerkits | pricing | coach | guarantee | clientvideos
  ...
  // header handlers (CHANGED: added file upload handler)
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", fontFamily: "system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      <aside style={{ width: 260, background: "#111827", color: "white", padding: 20, display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        <button onClick={() => setActiveTab("header")} style={{ width: "100%", textAlign: "left", padding: "8px 10px", borderRadius: 6, border: "none", background: activeTab === "header" ? "#FBBF24" : "transparent", color: activeTab === "header" ? "#111827" : "#E5E7EB", fontSize: 13, cursor: "pointer", fontWeight: 600 }}>Header</button>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 640px", gap: 20 }}>
                ...
                <div>
                  ...
                  <div style={{ marginBottom: 12 }}>
                    ...
                    {(!powerKitsForm.topBoxes || !Array.isArray(powerKitsForm.topBoxes)) && setPowerKitsForm(prev => ({ ...prev, topBoxes: prev.topBoxes || [
